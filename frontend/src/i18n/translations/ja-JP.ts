export default {
  ...
  "home.bullet.a.description": "Saka Shareをあなたのマシンでホストしましょう。",
  ...
  "admin.config.config-file-warning.description": "設定ファイル設定で済みのSaka ShareはUI を使用して設定を変更することはできません。",
  ...
  "admin.config.general.app-url.description": "Saka Shareで利用できるURL",
  ...
  "admin.config.cache.redis-enabled.description": "通常、Saka Share は情報をメモリ内にキャッシュします。複数の Saka Share インスタンスを実行する場合は、インスタンス間でキャッシュを共有するために Redis キャッシュを有効にする必要があります。",
