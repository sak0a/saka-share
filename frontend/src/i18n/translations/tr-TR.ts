export default {
  ...
  "home.bullet.a.description": "Saka Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "Saka Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "Saka Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Saka Share bilgileri bellekte önbellekler. Birden fazla Saka Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
