export default {
  ...
  "home.bullet.a.description": "Hostujte Saka Share na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je Saka Share nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je Saka Share k dispozici",
