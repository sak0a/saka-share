export default {
  ...
  "home.bullet.a.description": "Hostujte Saka Share na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali Saka Share pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan Saka Share",
  ...
  "admin.config.cache.redis-enabled.description": "Saka Share obično kešira informacije u memoriji. Ako pokrećete više instanci Saka Share-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
