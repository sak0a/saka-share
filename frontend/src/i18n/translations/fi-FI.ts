export default {
  ...
  "home.bullet.a.description": "Isännöi \"Saka Share\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella Saka Share on saatavilla",
