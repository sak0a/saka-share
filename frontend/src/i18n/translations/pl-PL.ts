export default {
  ...
  "home.bullet.a.description": "Utrzymuj Saka Share na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL Saka Share jest dostępny",
