export default {
  ...
  "home.bullet.a.description": "Host Saka Share on your own machine.",
  ...
  "admin.config.share.paste-max-size.description":
    "Maximum size of paste content in bytes",
  // END Paste
  ...
  "admin.config.config-file-warning.description":
    "As you have a configured Saka Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description":
    "On which URL Saka Share is available",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normally Saka Share caches information in memory. If you run multiple instances of Saka Share, you need to enable Redis caching to share the cache between the instances.",
