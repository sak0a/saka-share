export default {
  ...
  "home.bullet.a.description": "A Saka Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Saka Share megosztáskezelőre mutató hivatkozás",
