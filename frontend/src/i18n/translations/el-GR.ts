export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Saka Share στο δικό σας μηχάνημα.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured Saka Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Saka Share είναι διαθέσιμο",
